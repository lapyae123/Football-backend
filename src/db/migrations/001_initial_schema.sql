...
-- Initial tables: tabs, sources, matches, stream_urls, team_logos
...
CREATE TABLE IF NOT EXISTS team_logos (
    ...
    team_key   VARCHAR(255) UNIQUE NOT NULL,
...
INSERT INTO tabs (id, name, slug, position, source_type, is_active) VALUES
